...
export default function About(props) {
  let myStyle = {
    color: props.mode === "dark" ? "white" : "#2d5e68",
    backgroundColor: props.mode === "dark" ? "rgb(113 151 159)" : "white",
  };
  ...
  return (
    <div className="container py-2">
      <h1
        className="my-3"
        style={{ color: props.mode === "dark" ? "white" : "#2d5e68" }}
      >
        About Us
      </h1>
      <div className="accordion" id="accordionExample">
        ...
        <div className="accordion-item">
          ...
          >
            <div className="accordion-body" style={myStyle}>
              This word count software works in any web browsers such as chrome,
